# TÀI LIỆU HƯỚNG DẪN CÀI ĐẶT HỆ THỐNG OPENPKA
...
OpenPKA là một hệ thống quản lý đào tạo và quản trị tổ chức toàn diện, được xây dựng trên nền tảng Next.js 15. Hệ thống bao gồm các module chính:
...
# Tạo database
CREATE DATABASE openpka;

# Tạo user (tùy chọn)
CREATE USER openpka_user WITH PASSWORD 'your_password';
GRANT ALL PRIVILEGES ON DATABASE openpka TO openpka_user;
...
```bash
# Database
DATABASE_URL="postgresql://username:password@localhost:5432/openpka?schema=public"
...
- **DATABASE_URL**: Connection string đến PostgreSQL database
  ...
  - Ví dụ: `postgresql://postgres:password@localhost:5432/openpka?schema=public`
...
**Ngày cập nhật**: 2024  
**Tác giả**: OpenPKA Development Team
