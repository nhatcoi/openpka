...
const ROUTE_PERMISSIONS: Record<string, string[]> = {
    ...
    '/tms/programs': ['tms.program.view', 'tms.program.manage'],
    '/tms/programs/new': ['tms.program.create', 'tms.program.manage'],
    '/tms/programs/[id]': ['tms.program.view', 'tms.program.manage'],
    '/tms/programs/[id]/edit': ['tms.program.update', 'tms.program.manage'],
...
const API_ROUTE_PERMISSIONS: Record<string, string[]> = {
    ...
    'GET:/api/tms/programs': ['tms.program.view', 'tms.program.manage'],
    'POST:/api/tms/programs': ['tms.program.create', 'tms.program.manage'],
    'GET:/api/tms/programs/[id]': ['tms.program.view', 'tms.program.manage'],
    'PUT:/api/tms/programs/[id]': ['tms.program.update', 'tms.program.manage'],
    'PATCH:/api/tms/programs/[id]': ['tms.program.update', 'tms.program.manage'],
    'DELETE:/api/tms/programs/[id]': ['tms.program.delete', 'tms.program.manage'],
    'GET:/api/tms/programs/stats': ['tms.program.view', 'tms.program.manage'],
};
